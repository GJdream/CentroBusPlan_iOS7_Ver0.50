...
- (void)viewDidLoad
{
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"Touch %d product/service characteristics that are important to %@'s customers.", MAX_VALUE_SELECTION, [SSUtils companyName]];
}

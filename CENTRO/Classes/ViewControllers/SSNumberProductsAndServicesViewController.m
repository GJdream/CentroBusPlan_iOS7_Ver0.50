...
- (void) questions {
    if (self.company.productsAndServicesEstimate == [NSNumber numberWithInt:1]) {
        ...
        self.questionsArray = [NSArray arrayWithObjects:[NSString stringWithFormat:@"How many products does %@ sell?", [SSUtils companyName]], [NSString stringWithFormat:@"How many services does %@ sell?", [SSUtils companyName]], nil];
